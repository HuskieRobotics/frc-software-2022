...
private WPI_TalonFX rightFlywheelMotor;
    ...
    */
    ...
    leftFlywheelMotor = new WPI_TalonFX(FlywheelConstants.LEFT_FLYWHEELMOTOR_CANID); 

    rightFlywheelMotor = new WPI_TalonFX(FlyhweelConstants.RIGHT_FLYWHEELMOTOR_CANID);
