    ...
    */
    ...
    public void setHoodSetpoint(double rotations){
        ...
        if (rotations > getHoodEncoderPosition()) {
            hoodMotor.set(ControlMode.Position, rotations, DemandType.ArbitraryFeedForward, ARBITRARY_FEED_FORWARD_UP_IN_PERCENT);
        }
        else {
            hoodMotor.set(ControlMode.Position, rotations, DemandType.ArbitraryFeedForward, ARBITRARY_FEED_FORWARD_DOWN_IN_PERCENT);
        }
