...
public class Hood extends SubsystemBase {
    ...
    */
    ...
    if (TUNING) {
        ...
        Shuffleboard.getTab("Hood").add("Aim for Wall", new InstantCommand(this :: aimForWall));
    ...
    public void setHoodSetpoint(double rotations){
         ...
         */
        hoodMotor.set(ControlMode.Position, rotations, DemandType.ArbitraryFeedForward, ARBITRARY_FEED_FORWARD_IN_PERCENT);
    }
