...
public class Feeder extends SubsystemBase {
    ...
    */
    public Feeder() {
        ...
        // with testing specific commands, which should be done in test mode (i.e., not
        // teleop).
        Shuffleboard.getTab("Intake").addBoolean("FeederCargoDetected", this::isCargoAdvanced);
