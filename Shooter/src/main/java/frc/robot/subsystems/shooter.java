...
public class shooter extends SubsystemBase {
    ...
    private Map<Double, Integer> shooterPowerLookUp; 
...
private NetworkTableEntry leftClosedLoopErrorNT;
    ...
    */
    public shooter() {
        ...
        this.shooterPowerLookUp =  new HashMap<>();
    ...
    public void setHoodPower(double pwr){
        //test to see if power needs to be negative
    ...
    public void addShooterPowerMap(double distance, int velocity){
        shooterPowerLookUp.put(distance, velocity);
    }
    

    //distance refers to value ty reads on limelight
    //returns the velocity to set the wheel at
    public int getShooterPowerMap(Double distance){
        return shooterPowerLookUp.get(distance);
    }
