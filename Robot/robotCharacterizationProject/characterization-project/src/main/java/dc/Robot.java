...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(16, Sides.LEFT, false);

    WPI_TalonFX leftFollowerID10 = setupWPI_TalonFX(10, Sides.FOLLOWER, false);
    leftFollowerID10.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(13, Sides.RIGHT, false);
    ...
    PigeonIMU pigeon = new PigeonIMU(18);
    gyroAngleRadians = () -> {
