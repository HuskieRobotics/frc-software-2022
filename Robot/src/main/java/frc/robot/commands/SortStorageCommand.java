...
public class SortStorageCommand extends CommandBase {
     ...
     * 
     * If cargo is detected at the collector end of the storage and not at the shooter end, it runs
     * the storage belt in the intake direction.
     * 
     * If cargo is detected at the shooter end of the storage, it continues to run the storage in
     ...
     * cargo is detected at both the shooter and collector end of the storage and the indexing of
     * the cargo at the shooter end has completed. It is critical that this command doesn't finish
     * until the indexing is compelte or else the cargo may still be touching the flywheel and then
     * inadvertantly shot.
     */
    @Override
