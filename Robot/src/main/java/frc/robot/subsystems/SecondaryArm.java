...
public class SecondaryArm extends SubsystemBase {
  ...
  public SecondaryArm() {
    ...
    secondaryMechanism =
        new Solenoid(
            SecondMechanismConstants.PNEUMATIC_HUB_CAN_ID,
    ...
    if (COMMAND_LOGGING) {
      Shuffleboard.getTab("Elevator")
          .add("Second Arm Out", new InstantCommand(this::moveSecondaryArmOut));
      Shuffleboard.getTab("Elevator")
          .add("Second Arm In", new InstantCommand(this::moveSecondaryArmIn));
