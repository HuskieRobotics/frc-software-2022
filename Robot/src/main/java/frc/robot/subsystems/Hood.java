    ...
    */
    public Hood() {
        ...
        Shuffleboard.getTab("Shooter").add("MoveHoodForFenderCommand",
                new MoveHoodCommand(this, Constants.HOOD_FENDER_POSITION));
    ...
    public void periodic() {
        ...
        if (Constants.TUNING) {
            this.talonSRX3.config_kF(Constants.HOOD_SLOT_INDEX, 0.0,
                    Constants.HOOD_TIMEOUT_MS);
            this.talonSRX3.config_kP(Constants.HOOD_SLOT_INDEX, this.PConstantNT.getDouble(0.0),
                    Constants.HOOD_TIMEOUT_MS);
            this.talonSRX3.config_kI(Constants.HOOD_SLOT_INDEX, this.IConstantNT.getDouble(0.0),
                    Constants.HOOD_TIMEOUT_MS);
            this.talonSRX3.config_kD(Constants.HOOD_SLOT_INDEX, this.DConstantNT.getDouble(0.0),
                    Constants.HOOD_TIMEOUT_MS);
