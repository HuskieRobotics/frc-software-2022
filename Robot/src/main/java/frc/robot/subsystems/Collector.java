 ...
 */
    ...
    private NetworkTableEntry isPistonExtendedNT;
    ...
    */
    ...
    this.isPistonExtendedNT = Shuffleboard.getTab("Collector")
    ...
    public void periodic() {
        ...
        this.isPistonExtendedNT.setBoolean(this.isPistonExtended());
        if(TUNING){
