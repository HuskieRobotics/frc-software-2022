 ...
 */
    ...
    private NetworkTableEntry isPistonExtenedNT;
    ...
    */
    ...
    this.isPistonExtenedNT = Shuffleboard.getTab("Collector")
    ...
    public void periodic() {
        ...
        this.isPistonExtenedNT.setBoolean(this.isPistonExtended());
        if(TUNING){
