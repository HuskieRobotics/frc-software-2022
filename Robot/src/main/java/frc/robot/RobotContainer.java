...
public class RobotContainer {
  ...
  private JoystickButton joystickButton1_3;
...
public boolean getJoystick1_3(){
  SmartDashboard.putBoolean("this button value", joystickButton1_3.get());
  return this.joystickButton1_3.get();
}
