...
public class RobotContainer {
  ...
  private final Joystick operatorConsole = new Joystick(3);
  ...
  private final JoystickButton[] operatorConsoleButtons;
...
// The robot's subsystems
  ...
  private RobotContainer() {
    ...
    m_drivetrainSubsystem.setDefaultCommand(new DefaultDriveCommand(
      ...
      this.operatorConsoleButtons = new JoystickButton[17];
      ...
      for(int i = 1; i <= operatorConsoleButtons.length; i++){
        operatorConsoleButtons[i-1] = new JoystickButton(operatorConsole, i);
     }
