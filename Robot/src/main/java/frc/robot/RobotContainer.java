...
public class RobotContainer {
  ...
  private final DrivetrainSubsystem m_drivetrainSubsystem = null; //new DrivetrainSubsystem();

  // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
  // The robot's subsystems
  private final Storage m_storage = null;  //new Storage();
  private final Collector m_collector = null; //new Collector();

  private WPI_TalonSRX testSRX;
