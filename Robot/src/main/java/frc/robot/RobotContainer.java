...
private final Joystick joystick0 = new Joystick(0);
  ...
  private RobotContainer() {
    ...
    m_drivetrainSubsystem.setDefaultCommand(new DefaultDriveCommand(
        ...
        /*
        () -> -(joystick0.getY()) * DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND,
        () -> -(joystick0.getX() * DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND),
        () -> -(joystick1.getX() * DrivetrainSubsystem.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND)));*/
        () -> -modifyAxis(joystick0.getY() * 3/4) * DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND,
        () -> -modifyAxis(joystick0.getX()* 3/4) * DrivetrainSubsystem.MAX_VELOCITY_METERS_PER_SECOND,
        () -> -modifyAxis(joystick1.getX() * 3/4) * DrivetrainSubsystem.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND));
  ...
  private void configureButtonBindings() {
    ...
    joystickButton1_2.whileHeld(new InstantCommand(() -> m_drivetrainSubsystem.setXStance()) , true);
    joystickButton1_2.whenPressed(new InstantCommand(() -> m_drivetrainSubsystem.disableJoystickControlls()) , true);
    joystickButton1_2.whenPressed(new InstantCommand(() -> m_drivetrainSubsystem.enableJoystickControlls()) , true);
