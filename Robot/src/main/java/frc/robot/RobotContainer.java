...
private final Joystick joystick0 = new Joystick(0);
  ...
  private void configureButtonBindings() {
    ...
    //commented out below to replace with new code.
    //joystickButton1_10.whenPressed(new InstantCommand(() -> m_drivetrainSubsystem.fieldRelativeToggle()));



    //What Mr. Schmitt said (use a toggleWhenpressed and startEndCommand)
    joystickButton1_10.toggleWhenPressed(new StartEndCommand(
      m_drivetrainSubsystem::DefaultDriveCommand, 
      m_drivetrainSubsystem::FieldRelativeDriveCommand,
      joystickButton1_10::get()));
    
    // What Aiden said (use when pressed and a conditional command)
    joystickButton1_10.whenPressed(ConditionalCommand(DefaultDriveCommand, FieldRelativeDriveCommand, toggleWhenPressed == true));
