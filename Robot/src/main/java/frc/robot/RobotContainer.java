...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    joystickButton1_10.whenPressed(new ZeroGyro(m_drivetrainSubsystem));
        
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=BUTTONS
    // Create some buttons
    final JoystickButton joystickButton1 = new JoystickButton(joystick0, 1);
    joystickButton1.whileHeld(new CollectorOn(0.6, m_collector), true);
    SmartDashboard.putData("Joystick Button 1", new CollectorOn(0.6, m_collector));
