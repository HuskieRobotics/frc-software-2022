...
public final class Constants {
  ...
  public static final class StorageConstants {
    ...
    public static double STORAGE_DEFAULT_SPEED = 0.6;   // FIXME: tune
    public static final int STORAGE_CAMERA_PORT = 0;
    public static final int TIMEOUT_MS = 30;
    public static  int INDEXING_FORWARD_DELAY = 16;   // FIXME: tune
    public static  int INDEXING_BACKWARD_DURATION = 2;   // FIXME: tune
  }
