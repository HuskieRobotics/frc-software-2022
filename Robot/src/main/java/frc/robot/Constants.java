...
public final class Constants {
  ...
  public static final class StorageConstants {
    ...
    public static final double STORAGE_DEFAULT_SPEED = 0.6;   // FIXME: tune
    public static final int STORAGE_CAMERA_PORT = 0;
    public static final int TIMEOUT_MS = 30;
    public static final int INDEXING_FORWARD_DELAY = 20;   // FIXME: tune
    public static final int INDEXING_BACKWARD_DURATION = 10;   // FIXME: tune
  }
