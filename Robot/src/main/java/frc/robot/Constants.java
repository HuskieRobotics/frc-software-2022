...
public final class Constants {
  ...
  public static final class DrivetrainConstants {
    ...
    /* Limelight */
    public static  double LIMELIGHT_F = 0.05; // FIXME: make static
    public static  double LIMELIGHT_P = 0.1; // FIXME: make static
    public static  double LIMELIGHT_I = 0.0; // FIXME: make static
    public static  double LIMELIGHT_ALIGNMENT_TOLERANCE = .8; // FIXME: make static
