...
// Create some buttons
    ...
    XboxButtons[0].whenPressed(new InstantCommand(() -> m_collector.deployCollectorPiston()));
    XboxButtons[3].whenPressed(new InstantCommand(() -> m_collector.retractCollectorPiston()));
    ...
    //intake
    //Need to be able to run a command group when enabled and run another when disabled, problem with just toggle is that it
    //will just cancel the command leaving the collector speed and collector deployed
    
      joystickButtons1[1].toggleWhenPressed(
         new ConditionalCommand(
          new SequentialCommandGroup(
            new InstantCommand(() -> m_collector.setCollectorPower(.4)),
            ...
            new ParallelCommandGroup(
              ...
              new InstantCommand(() -> m_storage.setStoragePower(0))),joystickButtons1[1] :: get));
