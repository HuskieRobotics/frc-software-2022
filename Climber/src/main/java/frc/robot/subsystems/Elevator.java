...
public class Elevator extends SubsystemBase {
    ...
    private NetworkTableEntry magicMotionButton;
...
public Elevator() {
    ...
    /* Config the peak and nominal outputs */
        ...
        leftElevatorMotor.configMotionSCurveStrength(0);
        rightElevatorMotor.configMotionSCurveStrength(0);
        leftElevatorMotor.configMotionCruiseVelocity(5000);
        rightElevatorMotor.configMotionCruiseVelocity(5000);
        leftElevatorMotor.configMotionAcceleration(TEST, TEST);
        ...
        this.magicMotionButton = Shuffleboard.getTab("Elevator")
            .add("test magic motion ", false)
            .withWidget(BuiltInWidgets.kToggleButton)
            .getEntry();
    ...
    if (TUNING) {
        ...
        if(this.magicMotionButton.getBoolean(false)) {
            this.setElevatorMotorPositionTest();
        }
    }      
    ...
    public void setElevatorMotorPositionTest() { 
        leftElevatorMotor.set(TalonFXControlMode.MotionMagic, 1024);
